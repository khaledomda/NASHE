  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Let's Build the Future of Arab Football
        ...
        >
          ناشي — Nashe. Contact us to join the platform or partner with us.
        </p>
        ...
        <div style={{ display: "flex", gap: "4vw" }}>
          <div>
            ...
            <div style={{ fontSize: "1.4vw", fontWeight: 600, color: "white" }}>
              nashe.app
            </div>
          </div>
          <div>
