  ...
  return (
    ...
    >
      ...
      <div style={{ marginBottom: "6vh" }}>
        ...
        >
          From scout to discovery in four steps<span style={{ color: "#F97316" }}>.</span>
        </h1>
      </div>
      ...
      >
        ...
        >
          ...
          <div style={{ fontSize: "1.5vw", fontWeight: 700, color: "#111827", lineHeight: 1.2 }}>
            Log In
          </div>
          <div style={{ fontSize: "1.1vw", color: "#4B5563", lineHeight: 1.45 }}>
            Scout logs in securely to their ناشي account.
          </div>
        </div>
        ...
        >
          ...
          <div style={{ fontSize: "1.1vw", color: "#4B5563", lineHeight: 1.45 }}>
            Scout films a player and uploads a clip with name, position, and region.
          </div>
        </div>
        ...
        >
          ...
          <div style={{ fontSize: "1.5vw", fontWeight: 700, color: "white", lineHeight: 1.2 }}>
            Clip Goes Live
          </div>
          <div style={{ fontSize: "1.1vw", color: "rgba(255,255,255,0.75)", lineHeight: 1.45 }}>
            Clip appears in the discovery feed for scouts and club representatives.
          </div>
        </div>
        ...
        >
          ...
          <div style={{ fontSize: "1.1vw", color: "#4B5563", lineHeight: 1.45 }}>
            Interested parties view the full profile and contact the scout directly.
          </div>
        </div>
      </div>
