...
const CONTACTS = [
  { id: 'c1', name: 'سارة العتيبي', phone: '05xxxxxxx1', email: 'sara@example.com', club: '—' },
  { id: 'c2', name: 'فيصل الجريني', phone: '05xxxxxxx2', email: 'faisal@example.com', club: 'نادي الهلال' },
];
